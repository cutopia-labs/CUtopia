...
export const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.CREATE_USER_INVALID_EMAIL]: 'Invalid SID',
  [ERROR_CODES.CREATE_USER_USERNAME_EXISTS]: 'Username already exist!',
  [ERROR_CODES.CREATE_USER_EMAIL_EXISTS]: 'SID already exist!',
  ...
  [ERROR_CODES.CREATE_REVIEW_ALREADY_CREATED]: 'Already created review!',
